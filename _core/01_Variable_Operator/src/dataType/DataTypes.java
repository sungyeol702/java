...
public class DataTypes {
	...
	public static void main(String[] args) {
		...
		System.out.println("실수형 : flot(32bit)-리터럴 표기법 사용, doble(64bit)");
		System.out.println("float 과 doble의 차이를 구분하기 어렵기 때문에");
		...
		//모든 산술, 비교(==은 제외), 논리 연산은 불가능
		//단 null은 dataType이 null object라 할 수 있슴
		System.out.println(null+"dfdf");
	}
